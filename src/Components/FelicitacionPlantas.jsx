...
const FelicitacionPlantas = () => {
    ...
    return (
      <>
        <Navbar/>
        <div className="cuerpo-plantas-felicitacion">
            <div className="contenedor-felicitaciones">
                ...
                <div className="botones-felicitacion">
                    <button onClick={() => handleNavigation('/plantas')}>Finalizar</button>
                </div>
            </div>
        </div>
      </>
  ...
  export default FelicitacionPlantas;